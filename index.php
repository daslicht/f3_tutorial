...
$f3->route('GET /viewAJAX',
 function($f3) {
    echo template::instance()->render('viewAJAX.html');
 }
);
 ...
 * 
 */
$f3->route('GET /cities/@cityname',
  function($f3) {
    $f3->set('html_title','Simple Input Form');
    $cityname = $f3->get('PARAMS.cityname');
    $f3->set("cityname", $cityname );

    $f3->set('content','city.html');
 ...
 * 
 */
$f3->route('GET /cities/@cityname/@theme',
  function($f3) {
    $f3->set('html_title','Simple Input Form');
    $cityname = $f3->get('PARAMS.cityname');
...
$f3->route('POST /simpleform',
  function($f3) {
	...
	$formdata["address"] = $f3->get('POST.address');		// whatever was called "address" on the form
    $formdata["dob"] = $f3->get('POST.dob');		// whatever was called "dob" on the form
    $formdata["hobby"] = $f3->get('POST.hobby');		// whatever was called "hobby" on the form
    $formdata["city"] = $f3->get('POST.city');		// whatever was called "city" on the form
